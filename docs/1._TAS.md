![TAS panel](screenshots/tas-panel.png)
...
Sets the magnitude to 48 and picks a control stick value that maximizes speed according to the air speed update equations.
